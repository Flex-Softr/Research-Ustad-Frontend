      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 pb-20 relative z-10">
          {events.map((event, index) => (
            <div
              key={event.id}
              className="group relative bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-brand-primary/30 shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden"
            >
              {/* Card Glow Effect */}
