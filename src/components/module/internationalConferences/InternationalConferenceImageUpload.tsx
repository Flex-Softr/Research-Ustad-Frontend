...
interface InternationalConferenceImageUploadProps {
...
export function InternationalConferenceImageUpload({
  onChange,
  value,
  ...
  isEditMode = false,
  required = false,
}: InternationalConferenceImageUploadProps) {
    ...
    <div className="space-y-4">
      ...
      <Card className={`border-2 border-dashed transition-colors ${
        ...
        <CardContent className="p-6">
          ...
          <Input
            ...
            required={required && (!preview && !existingImageUrl)}
          />
        </CardContent>
      </Card>
      ...
      {!preview && !isEditMode && (
        <p className="text-sm text-gray-500">
          Upload an image to represent this conference {required && <span className="text-red-500"> (Required)</span>}
        </p>
      )}
