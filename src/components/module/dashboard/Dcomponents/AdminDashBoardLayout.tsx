  ...
  const primaryMetrics = [
    ...
    },
    {
      ...
      change: calculateGrowthRate(
        ...
        (allInfo?.totalResearchPapers || 0) * 0.85
      ),
      changeType: getChangeType(
        allInfo?.totalResearchPapers || 0,
        (allInfo?.totalResearchPapers || 0) * 0.85
    ...
    },
    {
      ...
      change: calculateGrowthRate(
        ...
        (allInfo?.totalApprovedPapers || 0) * 0.8
      ),
      changeType: getChangeType(
        allInfo?.totalApprovedPapers || 0,
        (allInfo?.totalApprovedPapers || 0) * 0.8
    ...
    },
    {
      ...
      change: calculateGrowthRate(
        ...
        (allInfo?.totalPendingPapers || 0) * 1.2
      ),
      changeType: getChangeType(
        allInfo?.totalPendingPapers || 0,
        (allInfo?.totalPendingPapers || 0) * 1.2
  ...
  const secondaryMetrics = [
    {
      ...
      change: calculateGrowthRate(
        ...
        (allInfo?.totalResearchMembers || 0) * 0.9
      ),
      changeType: getChangeType(
        allInfo?.totalResearchMembers || 0,
        (allInfo?.totalResearchMembers || 0) * 0.9
