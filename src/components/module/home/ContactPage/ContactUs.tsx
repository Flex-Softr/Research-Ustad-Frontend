        ...
        <div className="bg-white shadow-lg rounded-xl p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 text-gray-700">
              ...
              <span>info@noyourclient.org</span>
            </div>
            <div className="flex items-center space-x-4 text-gray-700">
