    ...
    <div className="container mx-auto px-4 py-16 lg:px-24 bg-gray-50">
      ...
      <div className="text-center mb-16">
        ...
        <p className="mt-6 text-lg text-gray-700 max-w-3xl mx-auto">
          We are committed to advancing knowledge and innovation through
          rigorous research. Join us in exploring new frontiers.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white shadow-lg rounded-xl p-8">
          ...
          <p className="text-gray-600 text-lg mb-6">
            Reach out for collaborations, inquiries, or more information.
          </p>
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <Link
              href="www.youtube.com/@ResearchUstad"
              className="p-3 bg-green-500 text-white rounded-full shadow-md hover:bg-green-600 transition"
            >
              <FaWhatsapp className="w-5 h-5" />
            </Link>
            <Link
              href="www.linkedin.com/company/researchustad"
              className="p-3 bg-blue-800 text-white rounded-full shadow-md hover:bg-blue-900 transition"
            >
              <FaLinkedinIn className="w-5 h-5" />
            </Link>
            <Link
              href="www.facebook.com/groups/research.ustadbd"
              className="p-3 bg-blue-600 text-white rounded-full shadow-md hover:bg-blue-700 transition"
            >
              <FaFacebookF className="w-5 h-5" />
            </Link>
